							...
							<div id="content_oc" class="col-sm-12">
								<div class="box_oc">
									<div class="box-heading">
										<h1 class="mrshop_heading_h1">Result of search "<%=searchword%>"</h1>
									</div>
														...
														<div class="caption">
															<div class="name">
																<a href="goodsDetail.jsp?ID=<%=ID%>" style="width: 95%">
																	<span style="color: #0885B1">BookName：</span><%=goodsName%></a>
															</div>
															<p class="price">
																<span class="price-new">Type：</span> <span><%=TypeName%></span>
																<span class="price-tax">Price: <%=nowPrice%>RM
																</span>
															</p>
														</div>
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													<td height="30" align="right">This Page：[<%=Page%>/<%=maxPage%>]&nbsp;
														...
														<a
														href="search_result.jsp?Page=<%=Page - 1%>&searchword=<%=searchword%>">Previous Page</a>
														<%
															}
															if (Page < maxPage) {
														%> <a
