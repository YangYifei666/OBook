		...
		<div class="row">
			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					...
					<div class="login">
						<div class="page-header" style="pause: 0px;"> <h1 class="login_h1">Account Login</h1> </div>
						<!-- 会员登录表单 -->
						<form action="login_check.jsp" method="post" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="password-lbl" for="password" class="required">Verification ：</label>
									</div>
								...
								<div class="form-group"
									...
									<label
										...
										href="register.jsp">Register</a></label>
								</div>
							</fieldset>
						</form>
					</div>
