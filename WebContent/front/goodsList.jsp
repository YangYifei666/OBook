...
<%
	...
	ResultSet rs = conn
			.executeQuery("select * from tb_goods t1,tb_subType t2 where t1.typeID=t2.ID and t1.num>=1 and t2.superType="
												...
												<div class="product-thumb">
														...
														<div class="button-group btn-grid">
															<div class="cart">
																<button class="btn btn-primary btn-primary"
																	...
																	data-original-title="Add to shopping cardS">
													...
													<div>
														<div class="caption">
															...
															<p class="price">
																<span class="price-tax">Price: <%=price%>RM
																</span>
															</p>
														</div>
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													<td height="30" align="right">This Page：[<%=Page%>/<%=maxPage%>]&nbsp;
														...
														href="goodsList.jsp?Page=<%=Page - 1%>&type=<%=type%>">Previous page</a>
														<%
															}
