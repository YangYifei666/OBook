...
<%
	...
	float price = 0;//定义保存商品价格的变量
	float number=0;
	if (rs.next()) {//如果查询到指定商品
		price = rs.getFloat("price");//获取该商品的价格
		number= rs.getFloat("num");
	}
	...
	mygoodselement.price = price;//将商品价格保存到mygoodselement对象中
