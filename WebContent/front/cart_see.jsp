							...
							<div id="content_oc" class="col-sm-12">
								...
								<div class="table-responsive cart-info">
									<table class="table table-bordered">
										<thead>
											<tr>
												<td class="text-center image">Picture</td>
												<td class="text-left name">Name</td>
												<td class="text-left quantity">Number</td>
										...
										<!-- 遍历购物车中的商品并显示 -->
											<%
												...
												for (int i = 0; i < cart.size(); i++) {
													...
													sum = sum + goodsitem.number * goodsitem.price;//计算总计金额
											...
											<tr>
												...
												<%if(goodsitem.number>num){ %>
												<td class="text-left quantity"><%=num%></td>
												<%}else{%>
												<td class="text-left quantity"><%=goodsitem.number%></td>
												<%} %>
												<td class="text-right price"><%=goodsitem.price%>RM</td>
												<td class="text-right total"><%=(goodsitem.price * goodsitem.number)%>RM
												</td>
											</tr>
											<!-- 显示一条商品信息 -->
											<%
								...
								<form action="cart_order.jsp" method="post" id="myform">
									<div class="table-responsive cart-info">
										<table class="table table-bordered">
											<tbody>
												<tr>
													<td class="text-right" width="20%">Name：</td>
												...
												<tr>
													<td class="text-right">PhoneNum：</td>
													<td class="text-left quantity">
														<div class="input-group btn-block" style="max-width: 400px;">
						...
						<div class="row">
							<div id="content_oc" class="col-sm-12">
								...
								<div class="buttons">
									...
									<div class="pull-left">
										<a href="cart_clear.jsp" class="btn btn-primary btn-default">Delete</a>
									</div>
									<div class="pull-right">
										<a href="javascript:zhifu();" class="tigger btn btn-primary btn-primary">Payment</a>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		function zhifu() {
			...
			var html = '<div class="popup_cont">'
					+ '<p>Payment</p>'
					+ '<strong><font id="show_money_info">0.01RM</font></strong>'
			...
			$.jBox.open(content, 'Payment', 400, 450);//打开支付窗口
		}
	</script>
	<!-- // 使用jBox插件实现一个支付对话框 -->
</body>
