...
<table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="96%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF">
              <tr>
                <td width="14%" height="27" align="center"> UserName</td>
                <td width="14%" align="center">TrueName</td>
                <td width="14%" align="center">PhoneNumber</td>
                <td width="26%" align="center">Email</td>
                <td width="10%" align="center">accountType</td>
...
for(int i=1;i<=pagesize;i++){
	  ...
	  String accountType=rs.getInt("accountType")==0 ? "Seller":"Buyer";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="27" align="right">ThisPage：[<%=Page%>/<%=maxPage%>]&nbsp;
	<%if(Page>1){%>
	<a href="membermanage.jsp?Page=1">FirstPage</a>　<a href="membermanage.jsp?Page=<%=Page-1%>">PreviousPage</a>
	<%
	}
	if(Page<maxPage){
	%>
	　<a href="membermanage.jsp?Page=<%=Page+1%>">NextPage</a>　<a href="membermanage.jsp?Page=<%=maxPage%>">LastPage&nbsp;</a>
	<%}
	%>	</td>
  </tr>
</table>
