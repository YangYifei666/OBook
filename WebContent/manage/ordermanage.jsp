  ...
  <tr>
						...
						<tr>
							...
							<td height="10" colspan="3">
								<form action="ordermanage.jsp" method="get" onsubmit="return search();" >
									<input type="text" placeholder="Enter order Number" name="orderId" id="orderId" />
	...
	if(RecordCount==0){
      ...
      <tr>
        <td height="29" align="right">&nbsp;</td>
        <td width="10">&nbsp;</td>
        <td width="1089" align="center" style="color:#000" class="word_white"><b>Null!</b></td>
        <td width="10">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="24" align="right">ThisPage：[<%=Page%>/<%=maxPage%>]&nbsp;
	<%
		if (Page > 1) {
	%>
	<a href="ordermanage.jsp?Page=1">FirstPage</a>　<a href="ordermanage.jsp?Page=<%=Page - 1%>">PreviousPage</a>
	<%
		}
		if (Page < maxPage) {
	%>
	　<a href="ordermanage.jsp?Page=<%=Page + 1%>">NextPage</a>　<a href="ordermanage.jsp?Page=<%=maxPage%>">LastPage&nbsp;</a>
	<%
		}
	%>	</td>
  </tr>
