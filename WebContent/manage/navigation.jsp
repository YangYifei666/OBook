...
<table width="199" height="431"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="80%" class="tableBorder_B_dashed"><a href="index.jsp">Goods Manage<br></a></td>
            </tr>
            <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="topmanage.jsp">Sale Top 10<br></a></td>
            </tr>
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="membermanage.jsp">Member Manage<br></a></td>
            </tr>
          <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="ordermanage.jsp?orderId=0" >Order Manage<br></a></td>
            </tr>
            <tr>
            <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF" width="10" height="11" /></td>
            <td class="tableBorder_B_dashed"><a href="logout.jsp">Exit Background<br></a></td>
            </tr>
            </table></td>
          </tr>
          <tr>
